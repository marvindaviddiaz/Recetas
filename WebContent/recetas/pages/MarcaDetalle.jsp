...
<rich:modalPanel id="modalPanel" style="modalPanel" autosized="true" moveable="false" onbeforeshow="effect_hide()" onbeforehide="effect_show()" onshow="effect_show()">
	...
	<f:facet name="header">
		<h:outputText value="Marcas" styleClass="subTituloPagina" />
	</f:facet>
	...
	<a4j:form id="detalle">
		...
		<h:panelGrid id="formularioDatos" columns="1">
			...
			<h:panelGrid id="pnlGrdContNombre" columns="3">
				<h:inputText id="nombre" required="true" styleClass="inputForm" value="#{marcaBean.nombre}" readonly="#{!marcaListBean.editable}">
			...
			<h:panelGrid columns="2">
				<a4j:commandButton id="aceptar" value="Aceptar" rendered="#{marcaListBean.editable}" action="#{marcaListBean.saveAction}" oncomplete="Richfaces.hideModalPanel('modalPanel');"
					reRender="panelListado">
				</a4j:commandButton>
				<a4j:commandButton id="cancelar" value="#{marcaListBean.labelBotonBack}" oncomplete="Richfaces.hideModalPanel('modalPanel');" immediate="true" >
				</a4j:commandButton>
			</h:panelGrid>
